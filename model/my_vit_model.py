...
from my_utils import ConsensusModule
...
class VisionTransformer(nn.Module):
    def __init__(self, args,img_size=224, patch_size=16, in_c=3, num_classes=1000,
                 ...
                 act_layer=None,consensus_type='avg'):
        """
        Args:
    ...
    def forward(self, x):
        ...
        x, attention_mask, position_ids = vtn_helper.pad_to_window_size_local(
            ...
            attention_mask,
            position_ids,
            self.temporal_encoder.config.attention_window[0],  # [18,18,18]
        ...
        max_position_embeddings = self.temporal_encoder.config.max_position_embeddings  # 288
...
def vit_base_patch16_224_in21k(args,num_classes: int = 21843, has_logits: bool = True):
    """
    ViT-Base model (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
