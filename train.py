...
def main(args):
    ...
    model = create_model(num_classes=25, has_logits=False,batch_size=batch_size,num_segments=args.num_segments).to(device)
    ...
    val_acc_best = 0
    best_path = './weights/{}_lr{}_batch{}_{}'.format(args.dataset_name,args.lr,batch_size,args.weights)
