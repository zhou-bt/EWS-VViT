...
def main(args):
    ...
    #congfusion matrix
    root_path = '/data/zhoubotong/dataset/ERA_Dataset/'
    labels = []
    ...
    if not os.path.exists(save_path):
        os.mkdir(save_path)
    plt.savefig(os.path.join(save_path, 'PY_RGB_16_MTSD_epoch50_ERA.png'), format='png')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/data/zhoubotong/project/0_mframe_input_module/weights/era_lr0.00025_batch1_vit_base_patch16_224_in21k.pth/model-best_70.8.pth',
