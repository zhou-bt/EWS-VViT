...
from vivit3_vi_cls import vit_base_patch16_224_in21k as create_model
from project.vit_8f_vivit.vivi2_stm_base.my_8f_utils import train_one_epoch, evaluate
...
def main(args):
    ...
    if args.weights != "":
        ...
        weights_dict2 = torch.load("/data/zhoubotong/project/0_mframe_input_module/weights/era_lr0.0005_batch2_vivit2_74.1/model-best.pth", map_location=device)
        weights_dict_2 = {}
        for k, v in weights_dict2.items():
            if 'temporal_blocks' in k:
                if '0.attn.qkv.weight' in k:
                    weights_dict_2['blocks.3.attn2.qkv.weight'] = v
                if '0.attn.qkv.bias' in k:
                    weights_dict_2['blocks.3.attn2.qkv.bias'] = v
                if '1.attn.qkv.weight' in k:
                    weights_dict_2['blocks.7.attn2.qkv.weight'] = v
                if '1.attn.qkv.bias' in k:
                    weights_dict_2['blocks.7.attn2.qkv.bias'] = v
                if '2.attn.qkv.weight' in k:
                    weights_dict_2['blocks.11.attn2.qkv.weight'] = v
                if '2.attn.qkv.bias' in k:
                    weights_dict_2['blocks.11.attn2.qkv.bias'] = v

                if '0.attn.proj.weight' in k:
                    weights_dict_2['blocks.3.attn2.proj.weight'] = v
                if '0.attn.proj.bias' in k:
                    weights_dict_2['blocks.3.attn2.proj.bias'] = v
                if '1.attn.proj.weight' in k:
                    weights_dict_2['blocks.7.attn2.proj.weight'] = v
                if '1.attn.proj.bias' in k:
                    weights_dict_2['blocks.7.attn2.proj.bias'] = v
                if '2.attn.proj.weight' in k:
                    weights_dict_2['blocks.11.attn2.proj.weight'] = v
                if '2.attn.proj.bias' in k:
                    weights_dict_2['blocks.11.attn2.proj.bias'] = v
        ...
        if 'module' in list(weights_dict.keys())[0]:
            ...
            model.load_state_dict(weights_dict, False)
            model.load_state_dict(weights_dict_2, False)
