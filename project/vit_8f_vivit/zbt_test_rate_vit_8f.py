...
from vivit2 import vit_base_patch16_224_in21k as create_model
...
def main(args):
    ...
    if not os.path.exists(save_path):
        os.mkdir(save_path)
    plt.savefig(os.path.join(save_path, 'era_vivit2_74.1'), format='png')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/data/zhoubotong/project/0_mframe_input_module/project/vit_8f_vivit/weights/era_lr0.0005_batch2_vit_base_patch16_224_in21k.pth/model-best.pth',
