...
def main(args):
    ...
    save_path = "/data/zhoubotong/dataset/confuse_mat/"
    if not os.path.exists(save_path):
        os.mkdir(save_path)
    plt.savefig(os.path.join(save_path, 'era_token_shift_72.2.png'), format='png')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/data/zhoubotong/project/0_mframe_input_module/project/vit_8f_token_shift/weights/era_lr0.00025_batch1_vit_base_patch16_224_in21k.pth/model-best.pth',
