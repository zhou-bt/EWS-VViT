...
from full_attention_cls import vit_base_patch16_224_in21k as create_model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-name', type=str, default='full attention cls')
    parser.add_argument('--save-path', type=str, default='/data/zhoubotong/dataset/confuse_mat')
    parser.add_argument('--weights', type=str, default='/data/zhoubotong/project/0_mframe_input_module/project/caiT/weights/era_lr0.0005_batch2_vit_base_patch16_224_in21k.pth/model-best.pth',
