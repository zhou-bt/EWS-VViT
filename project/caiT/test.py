...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-name', type=str, default='mod_fva_wta5_73.9')
    parser.add_argument('--save-path', type=str, default='/data/zhoubotong/dataset/confuse_mat')
    parser.add_argument('--weights', type=str, default='/data/zhoubotong/project/0_mframe_input_module/project/caiT/runs/fva-wta-cbam-w5/0.739193083573487_model-best.pth',
