...
from project.vit_8f.my_8f_utils import train_one_epoch, evaluate
...
def main(args):
    num_class, args.train_list, args.val_list, args.root_path, prefix = dataset_config.return_dataset(args.dataset_name,
                                                                                                      args.modality)
    # args.train_list, args.val_list, args.root_path, prefix = dataset_config.return_dataset(args.dataset_name,
    #                                                                                                   args.modality)
    ...
    model = create_model(batch_size, num_segments=args.num_segments, num_classes=args.num_classes, has_logits=False)
...
if __name__ == '__main__':
    ...
    # 数据集所在根目录
    parser.add_argument('--dataset_name', default='lxk', help='create model name')
