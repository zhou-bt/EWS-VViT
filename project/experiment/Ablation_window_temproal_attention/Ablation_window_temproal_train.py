...
from Ablation_window_temproal_attention import vit_base_patch16_224_in21k as create_model
...
def main(args):
    ...
    best_path = './weights/{}_lr{}_batch{}_{}_{}'.format(args.dataset_name,args.lr,batch_size,pre_wigth,curtime)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/data/zhoubotong/project/0_mframe_input_module/project/vit_base_p16_224_IN21K_k600_T8_TimeEmbed',
