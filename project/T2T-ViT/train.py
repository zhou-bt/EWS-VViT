...
from T2T_ViT import vit_base_patch16_224_in21k as create_model
...
def main(args):
    ...
    if args.weights != "":
        ...
        weights_dict = torch.load(args.weights, map_location=device)['state_dict_ema']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='./82.4_T2T_ViTt_19.pth.tar',
                        help='initial weights path')
    # 数据集所在根目录
