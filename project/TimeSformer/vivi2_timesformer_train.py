...
from timesformer_video_cls import vit_base_patch16_224_in21k as create_model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='../TimeSformer_divST_8x32_224_K600.pyth',
