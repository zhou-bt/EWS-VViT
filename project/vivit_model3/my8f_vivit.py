...
from my8f_vivit_utils import train_one_epoch, evaluate
...
def main(args):
    ...
    best_path = './weights/{}_lr{}_batch{}_{}'.format(args.project_name,args.lr,batch_size,args.dataset_name)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--project_name',default='vivit_model3')
