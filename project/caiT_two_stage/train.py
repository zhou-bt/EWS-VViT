...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        if val_acc > val_acc_best:
            ...
            torch.save(model.state_dict(), best_path+'/'+"gpu{}_model-best.pth".format(args.num_gpus))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='../two_stage_deprh12_checkpoint',
